...
public class DroneController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetButton("Horizontal") || Input.GetButton("Vertical"))
        {
            ...
            {
                transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(0.0f, transform.rotation.eulerAngles.y, 30.0f), Time.fixedDeltaTime);
            }
            ...
            {
                transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(-30.0f, transform.rotation.eulerAngles.y, 0.0f), Time.fixedDeltaTime);
            }
